...
# load para
# C:\Users\baili\PycharmProjects\CNN212
tf.flags.DEFINE_float("dev_sample_percentage", .1, "percentage of the training data to use for validation")
tf.flags.DEFINE_string("query_path","E:\\CNN212\\sets\\queries","query cases path")
tf.flags.DEFINE_string("docu_path","E:\\CNN212\\sets\\docus","documents cases path")
...
# Training parameters
tf.flags.DEFINE_integer("training_samples",294,"training set size")
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        cnn = DocCNN(document_length=FLAGS.document_length,document_num=x_train.shape[1],num_classes=y_train.shape[1],embedding_size=FLAGS.embedding_size,filter_sizes=list(map(int, FLAGS.filter_sizes.split(","))), num_filters=FLAGS.num_filters,full_layers=FLAGS.full_layers,l2_reg_lambda=FLAGS.l2_reg_lambda)
